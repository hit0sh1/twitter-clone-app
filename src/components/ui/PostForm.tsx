...
export default function PostForm({ user }: { user: UserProfile }) {
  ...
  const createPostMutation = useMutation({
    mutationFn: async (newPost: { content: string; handle: string; image: string | null }) => {
        ...
        <div className="flex-grow">
          ...
          <div className="border-t border-gray-100 pt-3 flex justify-between items-center">
            <div className="flex gap-2 text-blue-500">
              <button type="button" onClick={handleImageButtonClick} className="p-2 rounded-full hover:bg-blue-50">
                <FileImage size={18} />
              </button>
